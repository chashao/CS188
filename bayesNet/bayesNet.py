...
class Factor(object):
    ...
    def variableDomainsDict(self):
        " Returns a copy of the variable domains in the factor "
        return deepcopy(self.__variableDomainsDict)

    def variables(self):
        " Returns a copy of the tuple of variables in the factor "
        return copy(self.__variables)

    def variablesSet(self):
        " Returns a copy of the set of variables in the factor "
        return copy(self.__variablesSet)

    def unconditionedVariables(self):
        " Returns a copy of the unconditioned variables in the factor "
        return copy(self.__unconditionedVariables)

    def conditionedVariables(self):
        " Returns a copy of the conditioned variables in the factor "
